...
product.save!
product = Product.new({supplier_id: 2, name: "Lightsaber", price: 270, description: "Part laser, part samuri sword, all awesome. The lightsaber is an elogant weapon for a more civilized age, not nearly as clumsy as a blaster"})
product.save!
product = Product.new({supplier_id: 1, name: "Space Cowboy Laser Gun", price: 170, description: "This weapon has no other description than, Shiney!"})
product.save!
...
product.save!
product = Product.new({supplier_id: 1, name: "Yoda sleeping bag", price: 40, description: "For real, this is for real"})
product.save!
